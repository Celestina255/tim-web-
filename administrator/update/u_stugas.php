...
mysqli_query($con, "UPDATE tb_detailsurat SET no='$no', nik='$nip', nama='$nama', detail='$detail' WHERE kode='$kode'");
...
echo "<script>alert('Surat Tugas berhasil dibuat!'); window.location = '../../administrator/index.php?page=c_surattugas&kode=$kode'</script>"; 		
