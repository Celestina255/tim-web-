...
mysqli_query($con, "INSERT INTO t_datacalon (kode, nik, nama, binbinti, jk, tmp_lahir, tgl_lahir, kwng, agama, pkjn, prov, kab, kec, kelurahan, alamat, status, status_na) values('$kode','$nika','$namaa','$nmayaha','$jka','$tmp_lahira','$tgl_lahira','$kwnga','$agamaa','$pkjna','$prova','$kaba','$keca','$kelurahana','$almtca', '$statusa','$nna')");
...
echo "<script>alert('Surat Pengantar Nikah berhasil dibuat!'); window.location = '../../staff/index.php?page=c_n1-n6&kode=$kode'</script>"; 
}
?>
