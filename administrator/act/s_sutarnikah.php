...
mysqli_query($con, "INSERT INTO tb_datacalon (kode, nik, nama, binbinti, jk, tmp_lahir, tgl_lahir, kwng, agama, pkjn, prov, kab, kec, kelurahan, alamat, status, status_na) values('$kode','$nikb','$namab','$nmayahb','$jkb','$tmp_lahirb','$tgl_lahirb','$kwngb','$agamab','$pkjnb', '$provb','$kabb','$kecb','$kelurahanb','$almtcb', '$statusb','$nnb')");
...
echo "<script>alert('Surat Pengantar Nikah berhasil dibuat!'); window.location = '../index.php?page=c_n1-n6&kode=$kode'</script>"; 
}
?>
