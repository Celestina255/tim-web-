    ...
    <div class="au-card recent-report">
        <section class="welcome p-t-1s">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title-5">EDIT FOTO GALERI
                        </h1>
        ...
        <?php 
        $query = mysqli_query ($con, "SELECT * FROM tb_galeri where id='$_GET[id]'");
        while ($r = mysqli_fetch_array($query)){
         ?>

         <div class="modal-body">
            <form action="../aksi/u_galeri.php" method="post" name="form" id="form" onSubmit="return validasi(this)" enctype="multipart/form-data" class="form-horizontal">
                <div class="card-body card-block">
                  <div class="row form-group">
                    <div class="col col-md-3"><label for="nama" class=" form-control-label">Nama Foto</label></div>
                    <div class="col-12 col-md-6">
                        <input type="hidden" id="id" name="id" class="form-control" value="<?php echo $r['id'];?>"><input type="text" id="nama" name="nama" class="form-control" value="<?php echo $r['nama'];?>"></div>
                    </div>

                    <div class="row form-group">
                        <div class="col col-md-3"><label for="file" class=" form-control-label">Foto Galeri</label></div>
                        <div class="col-12 col-md-5"><input type="file" name="file" id="file" onchange="return fileValidation()" data-default-file="<?php echo '../img/galeri/'.$r['foto'];?>" class="form-control dropify"><small class="form-text text-muted">Ukuran : 550 x 366 Pixel, Max 1 MB</small></div>
                    </div>
