    ...
    <div class="au-card recent-report">
        <section class="welcome p-t-1s">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title-5">EDIT BERITA DESA
                        </h1>
        ...
        <?php 
        $query = mysqli_query ($con, "SELECT * FROM tb_berita JOIN tb_kategori ON tb_kategori.id_kategori=tb_berita.kategori where id_berita='$_GET[id]'");
        while ($row = mysqli_fetch_array($query)){
         ?>

         <div class="modal-body">
            <form action="../aksi/u_berita.php" method="post" name="form" id="form" onSubmit="return validasi(this)" enctype="multipart/form-data" class="form-horizontal">
                <div class="card-body card-block">
                  <div class="row form-group">
                    <div class="col col-md-2"><label for="judul" class=" form-control-label">Judul</label></div>
                    <div class="col-12 col-md-10"><input type="hidden" id="id" name="id" class="form-control" value="<?php echo $row['id_berita'];?>"><input type="text" id="judul" name="judul" class="form-control" value="<?php echo $row['judul'];?>" required ></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-2"><label for="slug" class=" form-control-label">Slug</label></div>
                    <div class="col-12 col-md-10"><input type="text" id="slug" name="slug" class="form-control" value="<?php echo $row['slug'];?>" required ><small class="form-text text-muted">Contoh : slug-diambil-dari-judul-berita</small></div>
                </div>

                <div class="row form-group">
                    <div class="col col-md-2"><label for="file" class=" form-control-label">Upload Gambar</label></div>
                    <div class="col-12 col-md-6"><input type="file" id="file" name="file" id="file" onchange="return fileValidation()" data-default-file="<?php echo '../img/berita/'.$row['gambar'];?>" class="form-control dropify" data-height="190"><small class="form-text text-muted">Ukuran : 780 x 540 Pixel, Max 1 MB</small></div>
                </div>

                <div class="row form-group">
                    <div class="col col-md-2"><label for="isi" class=" form-control-label">Isi Berita</label></div>
                    <div class="col-12 col-md-10"><textarea name="isi" id="ckeditor" required><?php echo $row['isi'];?></textarea></div>
                </div>
                <div class="row form-group">
