    ...
    <div class="au-card recent-report">
        <section class="welcome p-t-1s">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title-5">UPLOAD FOTO SLIDER
                        </h1>
        ...
        <div class="modal-body">
            <form action="../aksi/s_slider.php" method="post" name="form" id="form" onSubmit="return validasi(this)" enctype="multipart/form-data" class="form-horizontal">
                <div class="card-body card-block">
                <div class="row form-group">
                    <div class="col col-md-3"><label for="file" class=" form-control-label">Upload foto Slider</label></div>
                    <div class="col-12 col-md-5"><input type="file" id="file" name="file" id="file" onchange="return fileValidation()"  class="form-control dropify"><small class="form-text text-muted">Ukuran : 1600 x 800 Pixel, Max 1 MB</small></div>
                </div>
