    ...
    <div class="au-card recent-report">
        <section class="welcome p-t-1s">
            <div class="container">
                <div class="row">
                    <div class="col-md-9">
                        <h1 class="title-5">EDIT SURAT KETERANGAN CERAI
                        </h1>
                    </div>
        ...
        while($row =mysqli_fetch_array($data)){ 
            ...
            ?> 
            <form action="update/u_suketcerai.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-6"><input type="text" id="prov" name="prov" value="<?php echo $dt[7];?>" class="form-control"><small class="form-text text-muted">Contoh : Lampung</small></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="kab" class=" form-control-label">Kabupaten/Kota</label></div>
                        <div class="col-12 col-md-6"><input type="text" id="kab" name="kab" value="<?php echo $dt[8];?>" class="form-control"><small class="form-text text-muted">Contoh : Lampung Selatan</small></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="kec" class=" form-control-label">Kecamatan</label></div>
                        <div class="col-12 col-md-6"><input type="text" id="kec" name="kec" value="<?php echo $dt[9];?>" class="form-control"><small class="form-text text-muted">Contoh : Way Sulan</small></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="kelurahan" class=" form-control-label">Kelurahan</label></div>
                        <div class="col-12 col-md-6"><input type="text" id="kelurahan" name="kelurahan" value="<?php echo $dt[10];?>" class="form-control"><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                    </div>

                    <div class="row form-group">
                        <div class="col col-md-3"><label for="alamat" class=" form-control-label">Alamat</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="alamat" name="alamat"  value="<?php echo $dt[6];?>"class="form-control"><small class="form-text text-muted">Contoh : Kp. Durian Runtuh, RT./RW. 001/002</small></div>
                    </div>

                    <!-- ISTRI -->
                    <h6>DATA MANTAN ISTRI :</h6>
                    <hr>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-6"><input type="text" id="provi" name="provi"value="<?php echo $dt[18];?>" class="form-control"><small class="form-text text-muted">Contoh : Lampung</small></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="kabi" class=" form-control-label">Kabupaten/Kota</label></div>
                        <div class="col-12 col-md-6"><input type="text" id="kabi" name="kabi" value="<?php echo $dt[19];?>" class="form-control"><small class="form-text text-muted">Contoh : Lampung Selatan</small></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="keci" class=" form-control-label">Kecamatan</label></div>
                        <div class="col-12 col-md-6"><input type="text" id="keci" name="keci" value="<?php echo $dt[20];?>" class="form-control"><small class="form-text text-muted">Contoh : Way Sulan</small></div>
                    </div>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="kelurahani" class=" form-control-label">Kelurahan</label></div>
                        <div class="col-12 col-md-6"><input type="text" id="kelurahani" name="kelurahani" value="<?php echo $dt[21];?>" class="form-control"><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                    </div>

                    <div class="row form-group">
                        <div class="col col-md-3"><label for="alamati" class=" form-control-label">Alamat</label></div>
                        <div class="col-12 col-md-9"><input type="text" id="alamati" name="alamati"  value="<?php echo $dt[17];?>" class="form-control"><small class="form-text text-muted">Contoh : Kp. Durian Runtuh, RT./RW. 001/002</small></div>
                    </div>


                    <hr>
                    <h6>KETERANGAN PERCERAIAN </h6>
                    <hr>
                    <div class="row form-group">
                        <div class="col col-md-3"><label for="tgl_cerai" class=" form-control-label">Tanggal Perceraian</label></div>
                        <div class="col-12 col-md-4"><input type="text" id="tgl_cerai" name="tgl_cerai" class="form-control"  value="<?php echo $dt[22];?>" ></div>
                    </div>
