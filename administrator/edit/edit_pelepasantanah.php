    ...
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">EDIT KETERANGAN PELEPASAN TANAH TANAH
                            </h1>
...
<?php
            ...
            ?>
                                <form action="update/u_pelepasantanah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="nmsaksi3" name="nmsaksi3" value="<?php echo $dt[21]; ?>" required class="form-control"></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="nmsaksi4" class=" form-control-label">Nama Saksi 4</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="nmsaksi4" name="nmsaksi4" value="<?php echo $dt[22]; ?>" required class="form-control"></div>
                                </div>
