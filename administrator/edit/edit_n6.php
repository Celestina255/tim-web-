                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="sebab" name="sebab" value="<?php echo $dt[19]; ?>" class="form-control"><small class="form-text text-muted">Contoh : Sakit Liver</small></div>
                                    </div>
                                    <div class="row form-group">
