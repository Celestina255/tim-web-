...
<?php
 ...
 <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea rows="5" id="jawaban" name="jawaban" class="form-control"><?php echo $dt[5]; ?></textarea><small class="form-text text-muted">Contoh : Pencapaian Pembayaran Pajak Bumi dan Bangunan Kelurahan Dagelan sudah mencapai 75% sebagaimana data terlampir.</small></div>
                                    </div>
                                    <hr>
