                    ...
                    <form action="update/u_suketdomisili.php"  method="POST" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="sejak" name="sejak" value="<?php echo $dt[2]; ?>"   class="form-control"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="keperluan" class=" form-control-label">Keperluan</label></div>
                                        <div class="col-12 col-md-6"><input type="text" id="keperluan" name="keperluan" value="<?php echo $dt[3]; ?>" required class="form-control"><small class="form-text text-muted">Contoh : Melamar pekerjaan</small></div>
                                    </div>
<hr>
                                    <div class="row form-group">
