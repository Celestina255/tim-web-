    ...
    <div class="au-card recent-report">
     <section class="welcome p-t-1s">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="title-5">SURAT PENGANTAR SKCK
                    </h1>
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-6">
                    <select name="nmsurat" id="nmsurat" onchange="isiredaksi()" class="form-control">
                        ...
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS043' ORDER BY id ASC ");
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-6"><input type="text" id="nama" name="nama" placeholder="Nama Pemohon" required class="form-control"></div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-6"><input type="text" id="tmp_lahir" name="tmp_lahir" placeholder="Tempat Lahir Pemohon" required class="form-control"></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="tgl_lahir" class=" form-control-label">Tanggal Lahir</label></div>
                    <div class="col-12 col-md-4"><input type="text" id="tgl_lahir" name="tgl_lahir" placeholder="Tanggal Lahir Pemohon" required class="form-control"></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="pekerjaan" class=" form-control-label">Pekerjaan</label></div>
                    <div class="col-12 col-md-6"><input type="text" id="pekerjaan" name="pekerjaan" placeholder="Pekerjaan Pemohon" required class="form-control"></div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" id="untuk" name="untuk" placeholder="Peruntukan SKCK" class="form-control" required><small class="form-text text-muted">Contoh : Melamar Pekerjaan</small></div>
                </div>
                <hr>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-6"><input type="text" id="kepada" name="kepada" placeholder="Ditujukan kepada" class="form-control"><small>Misalanya : Ka. POLRES Fakfak / Ka. POLSEK Pariwari</small></div>
                </div>
                <div class="row form-group">
                    <div class="col col-md-3"><label for="di" class=" form-control-label">Alamat Tujuan /Di</label></div>
                    <div class="col-12 col-md-6"><input type="text" id="di" name="di" placeholder="Alamat Tujuan" class="form-control"><small>Misalanya : TEMPAT / Fakfak / Pariwai</small></div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body scroll">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat WHERE kodejenis='JS043' ORDER BY id ASC ");
                                    $no=1;
                                    while ($data = mysqli_fetch_assoc($query)){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $dt[7];?></td>
                                            <td>
                                                <a href="../cetak/c_skck.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_skck&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_skck.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
