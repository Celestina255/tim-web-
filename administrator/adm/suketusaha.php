                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat, tb_penduduk WHERE tb_detailsurat.kodejenis='JS001' AND tb_penduduk.nik=tb_detailsurat.nik ORDER BY tb_detailsurat.id DESC ");
                            $no=1;
