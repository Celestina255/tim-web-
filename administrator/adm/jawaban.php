            ...
            <div class="card-body card-block">
                        ...
                        <form action="act/s_jawaban.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS030' ORDER BY id ASC ");
...
<hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea rows="4" id="dasar" name="dasar" placeholder="Isi dengan dasar surat terkait" required class="form-control"></textarea><small class="form-text text-muted">Contoh : Surat Camat Way Sulan Nomor : 123, Tanggal 12 Mei 2023, Perihal Laporan Pencapaian Pembayaran Pajak Bumi dan Bangunan Tahun 2023</small></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="lbg" name="lbg" placeholder="Isi dengan Nama / Lembaga yang dituju" required class="form-control"><small class="form-text text-muted">Contoh : Camat Way Sulan</small></div>
                                    </div>
                                    <div class="row form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat WHERE kodejenis='JS030' ORDER BY id ASC ");
                            $no=1;
