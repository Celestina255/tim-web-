                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT tb_penduduk.*, tb_detailsurat.* FROM tb_penduduk, tb_detailsurat WHERE tb_detailsurat.kodejenis='JS005' AND tb_detailsurat.nik=tb_penduduk.nik ORDER BY tb_detailsurat.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../cetak/c_sukettmampuv1.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
