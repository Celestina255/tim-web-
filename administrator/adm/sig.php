...
<body>
    <div class="au-card recent-report">
     <section class="welcome p-t-1s">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="title-5">SURAT IZIN GANGUAN (SIG)
                    </h1>
    ...
    <form action="act/s_sig.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-8">
                    <select name="nmsurat" id="nmsurat" onchange="isiredaksi()" class="form-control">
                        ...
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS045' ORDER BY id ASC ");
                ...
                <hr>
                <h6 class="label">DATA USAHA/KEGIATAN YANG DILAKUKAN </h6>
                <hr>

                <div class="row form-group">
                    <div class="col col-md-3"><label for="namausaha" class=" form-control-label">Nama Usaha</label></div>
                    <div class="col-12 col-md-6"><input type="text" id="namausaha" name="namausaha" placeholder="Nama Usaha" required class="form-control"></div>
                </div>
                <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-2"><input type="number" id="jmlttg" name="jmlttg" placeholder="0" required class="form-control"></div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body scroll">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat WHERE kodejenis='JS045' ORDER BY id ASC ");
                                    $no=1;
                                    while ($data = mysqli_fetch_assoc($query)){
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $dt[2];?></td>
                                            <td>
                                                <a href="../cetak/c_sig.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_sig&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_sig.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
