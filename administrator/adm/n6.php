           ...
           <form action="act/s_n6.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
            ...
            <div class="row form-group">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-6"><input type="text" id="sebab" name="sebab" placeholder="Sebab Kematian" required class="form-control"><small class="form-text text-muted">Contoh : Sakit Liver</small></div>
                </div>
                <div class="row form-group">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body scroll">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat WHERE kodejenis='JS038' ORDER BY id DESC ");
                                    while ($r = mysqli_fetch_array($query)){
                                        $dt=explode(';', $r['detail']);
                                        ?>
                                        <tr>
