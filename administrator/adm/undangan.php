                        ...
                        <form action="act/s_undangan.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS025' ORDER BY id ASC ");
...
<hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="tmp" name="tmp"  placeholder="Isi dengan Tempat Acara" class="form-control"><small class="form-text text-muted">Contoh : Aula Kelurahan Dagelan</small></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat WHERE kodejenis='JS025' ORDER BY id ASC ");
                            $no=1;
