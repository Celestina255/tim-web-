                            ...
                            <div class="card">
                                ...
                                <div class="card-body scroll">
                                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            <?php 
                                            $query = mysqli_query ($con, "SELECT tb_penduduk.*, tb_detailsurat.* FROM tb_penduduk, tb_detailsurat WHERE tb_penduduk.nik=tb_detailsurat.nik AND  kodejenis='JS032' ORDER BY tb_detailsurat.id DESC ");
                                            $no=1;
