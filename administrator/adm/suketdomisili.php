                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT tb_detailsurat.*, tb_penduduk.* FROM tb_detailsurat, tb_penduduk WHERE tb_detailsurat.kodejenis='JS015' AND tb_detailsurat.nik=tb_penduduk.nik ORDER BY tb_detailsurat.id DESC ");
                            $no=1;
