    ...
    <div class="au-card recent-report">
               <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">SURAT KETERANGAN CERAI
                            </h1>
                            ...
                            <?php
                                ...
                                <form action="act/s_suketcerai.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS041' ORDER BY id ASC ");
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="kelurahan" name="kelurahan" placeholder="Kelurahan" class="form-control" required><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="kelurahani" name="kelurahani" placeholder="Kelurahan" class="form-control" required><small class="form-text text-muted">Contoh : Pamulihan</small></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-4"><input type="text" id="tgl_cerai" name="tgl_cerai" class="form-control" placeholder="Tanggal perceraian" required></div>
                                    </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat WHERE kodejenis='JS041' ORDER BY id ASC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../cetak/c_suketcerai.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_suketcerai&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_suketcerai.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
