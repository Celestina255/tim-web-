    ...
    <div class="au-card recent-report">
            <section class="welcome p-t-1s">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="title-5">KETERANGAN PELEPASAN TANAH
                            </h1>
                            ...
                            <?php
                                ...
                                <form action="act/s_pelepasantanah.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="card-body card-block">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS042' ORDER BY id ASC ");
                                ...
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="nmsaksi3" class=" form-control-label">Nama Saksi 3</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="nmsaksi3" name="nmsaksi3" placeholder="Nama Saksi 3" required class="form-control"></div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3"><label for="nmsaksi4" class=" form-control-label">Nama Saksi 4</label></div>
                                    <div class="col-12 col-md-9"><input type="text" id="nmsaksi4" name="nmsaksi4" placeholder="Nama Saksi 4" required class="form-control"></div>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat WHERE tb_detailsurat.kodejenis='JS042' ORDER BY tb_detailsurat.id DESC ");
                            $no=1;
                         ...
                         ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="../cetak/c_pelepasantanah.php?kode=<?php echo $data['kode'];?>" target="_BLANK" class="btn"><i class="fa fa-print"></i></a>
                                                <a href="?page=edit_pelepasantanah&amp;kode=<?php echo "$data[kode]"; ?>" class="btn"><i class="fa fa-edit"></i></a>
                                                <a href="hapus/h_pelepasantanah.php?kode=<?php echo $data['kode'];?>" class="btn"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
