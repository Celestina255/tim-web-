            ...
            <div class="card-body card-block">
                        ...
                        <form action="act/s_pengantar.php" onsubmit="return validasi_input(this)" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS026' ORDER BY id ASC ");
...
<hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><textarea id="dasar" name="dasar" rows="3" placeholder="Isi dengan dasar surat terkait " class="form-control"></textarea><small class="form-text text-muted">Contoh : Surat Camat Way Sulan Nomor : 123, Tanggal 12 Mei 2023, Perihal Laporan Penduduk Bulan Mei 2023</small></div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-6"><input type="text" id="lbg" name="lbg" placeholder="Isi dengan Nama / Lembaga yang dituju"  class="form-control"><small class="form-text text-muted">Contoh : Camat Way Sulan</small></div>
                                    </div>
                                    <div class="row form-group">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body scroll">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                        <?php 
                            $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat WHERE kodejenis='JS026' ORDER BY id ASC ");
                            $no=1;
