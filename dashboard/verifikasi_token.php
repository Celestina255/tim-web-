            ...
            <div class="container">
               ...
               <div class="row">
                  <div class="contact-wrapper full-contact">
                     <!-- Contact info end -->
                     <div class="col-lg-12">
                         <h3 class="column-title" align="center">Verifikasi Token</h3>
                              ...
                              <div class="row" align="center">
                                 <div class="col-lg-12">
                                    <div class="form-group">
                                       <input class="col-lg-3 form-control form-name" id="token" name="token" placeholder="Masukan token" type="text" required="">
                                    </div>
                                 </div>
                                 <!-- Col 12 end-->
                              </div>
                              <!-- Form row end-->
                              <button class="btn btn-danger tw-mt-30 center" type="submit" name="ver_tok"><i class="fa fa-key"></i> Verifikasi</button>
