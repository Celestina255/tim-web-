...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="4">Yang bertanda tangan dibawah ini <?php echo $rd['jnp']=='Desa'? "Kepala Kampung" : "Lurah";?> <?php echo $rd['kelurahan'];?> Distrik <?php echo $rd['kec'];?> Kabupaten <?php echo $rd['kab'];?>,dengan ini menerangkan sesngguhnya bahwa :</td>
  </tr>
    <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="4">Warga tersebut diatas adalah benar warga <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> yang masuk dalam kategori Keluarga Tidak Mampu sesuai Data Terpadu Kesejahteraan Sosial (DTKS).</td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
