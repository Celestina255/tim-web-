...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="4">Warga tersebut diatas adalah benar Warga <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> yang telah Menikah pada :</td>
  </tr>
    <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  ...
  <div style="width: 40%; float: right; text-align: left;">
    <div style="font-size: 12pt; line-height: 1.5;"><br><br><br><br><br><br>
