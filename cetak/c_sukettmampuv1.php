...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">warga tersebut diatas adalah benar warga <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> yang masuk dalam kategori Keluarga Tidak Mampu dan Surat Keterangan Tidak Mampu ini dipergunakan untuk :</td>
  </tr>
