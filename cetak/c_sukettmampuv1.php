...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td>Jenis Kelamin</td><td>:</td><td><?php echo $r['jk'];?></td>
      ...
      <tr>
    <td>Tmp. & Tgl. Lahir</td><td>:</td><td><?php echo $r['tmp_lahir'];?>, <?php echo tgl_lahir_indo($tgl_lahir);?> </td>
  </tr>
    <tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">warga tersebut diatas adalah benar warga <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> yang masuk dalam kategori Keluarga Tidak Mampu dan Surat Keterangan Tidak Mampu ini dipergunakan untuk :</td>
  </tr>
