...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
 ...
 <?php echo $rd['kelurahan'];?> Distrik <?php echo $rd['kec'];?> Kabupaten <?php echo $rd['kab'];?>, Dengan ini menerangkan bahwa : </td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[6];?> <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?>
 <?php echo $r['kelurahan'];?></td>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Nama tersebut diatas adalah Warga <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> yang telah meninggal dunia dan di <b>Kuburkan di Pemakaman <?php echo $dt[8]; ?> <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $rd['kelurahan'];?>  pada tanggal <?php echo $dt[7]; ?></b>.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
