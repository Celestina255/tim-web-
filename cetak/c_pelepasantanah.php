...
<table align="center" class="table-list" width="90%" border="0" cellspacing="0" cellpadding="1">
  <tr>
    <td colspan="5" align="justify">Yang bertanda tangan dibawah ini <?php echo $rd['jnp']=='Desa'? "Kepala Desa" : "Lurah";?> <?php echo $rd['kelurahan'];?> Kecamatan <?php echo $rd['kec'];?> Kabupaten <?php echo $rd['kab'];?>, menerangkan sebenar - benarnya bahwa telah terjadi Pelepasan Hak Milik atas Tanah dari Pihak I kepada pihak II sebagai berikut : </td>
  </tr>
      <tr>
    <td colspan="5">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td colspan="5" align="justify">Adapun Pelepasan Hak Milik atas Tanah dimaksud terjadi dikarenakan pada hari <?php echo strtoupper($hari);?> tanggal <?php echo IndonesiaTgl($tgl);?> Pihak I telah menjual sebidang tanah dengan luas/ukuran <?php echo format_angka($dt[12]);?> Ha./M2 yang terletak di <?php echo $dt[13];?> kepada Pihak II dengan harga <b>Rp. <?php echo format_angka($dt[14]);?></b>, <i>(<?php echo kekata($dt[14]);?> Rupiah)</i>, dengan batas - batas tanah : </td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="5" align="justify" align="justify">Demikian keterangan ini dibuat dengan sebenar - benarnya untuk dipergunakan sebagaimana mestinya.</td>
  </tr>
...
<tr>
  ...
  <tr>
    <td>3.</td><td><?php echo $dt[21];?></td><td colspan="2">(_______________)</td>
  </tr>
     <tr>
    <td colspan="4">&nbsp;<br></td><td></td>
  </tr>
  <tr>
    <td>4.</td><td><?php echo $dt[22];?></td><td colspan="2">(_______________)</td>
  </tr>
     <tr>
    <td colspan="4">&nbsp;<br></td><td></td>
  </tr>
...
<table width="90%" align="right" border="0" cellspacing="1" cellpadding="2" class="table-print">
  ...
  <tr>
    <td rowspan="3" width="30%"></td><td align="center" valign="top" class="pull pull-right"><?php echo $rd['jnp']=='Desa'? "Kepala Desa" : "Lurah";?> <?php echo $rd['kelurahan'];?></td>
  </tr>
  <tr>
