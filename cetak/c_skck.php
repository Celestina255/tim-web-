...
<table width="800" align="center" cellpadding="2">
    <tr>
        ...
        <td width="40%" valign="top" style="padding-top: 20px;">
  <div style="text-align: right; padding-right: 40px;">
    <?php echo $rd['kelurahan']; ?>, <?php echo tgl_indonesia($tgl_sekarang); ?><br><br>
  </div>
  <div style="padding-left: 105px; padding-right: 40px;">
    <table style="font-size: 12pt;" border="0" cellpadding="0" cellspacing="0">
      <tr><td>Kepada Yth :</td></tr>
      <tr><td>Bapak <?php echo $dt[8]; ?></td></tr>
      <tr><td>di</td></tr>
      <tr><td style="padding-left: 40px;"><b><?php echo $dt[9]; ?></b></td></tr>
    </table>
  </div>
</td>
...
<table width="800" align="center">
    <tr>
        <td align="center"><?php echo $rd['kelurahan']; ?>, <?php echo tgl_indonesia($tgl_sekarang); ?></td>
    </tr>
    <tr>
        <td align="center">
            <?php echo ($r['jab_staff'] == 'Kepala Kelurahan' || $r['jab_staff'] == 'Kepala Desa') ? '' : 'a.n.'; ?>
            <?php echo $rd['jnp'] == 'Desa' ? 'Kepala Kampung' : 'Kepala Kelurahan'; ?> <?php echo $rd['kelurahan']; ?><br>
