...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="3">Yang bertanda tangan dibawah ini <?php echo $rd['jnp']=='Desa'? "Kepala Kampung" : "Lurah";?> <?php echo $rd['kelurahan'];?> Distrik <?php echo $rd['kec'];?> Kabupaten <?php echo $rd['kab'];?>, Dengan ini menerangkan dengan bahwa : </td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>Tmp. & Tgl. Lahir</td><td>:</td><td><?php echo $dt[3];?>,<?php echo tgl_lahir_indo($dt[4]);?> </td>
  </tr>
    <tr>
    <td>Agama</td><td>:</td><td><?php echo $dt[5];?></td>
  </tr>
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[6];?> <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $r['kelurahan'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Adalah benar Warga <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $r['kelurahan'];?> Distrik <?php echo $r['kec'];?> dan benar berkelakuan baik serta tidak pernah terlibat dalam kasus Pidana maupun Perdata serta tidak pernah terlibat kasus kenakalan Remaja ataupun pemakaian obat-obatan terlarang (Narkoba). <br><br>Surat Keterangan ini kami berikan kepadanya untuk <?php echo $dt[7];?>.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
