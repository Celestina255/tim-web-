...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $r['alamat'];?> <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $r['kelurahan'];?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3">Nama tersebut diatas adalah Warga <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> yang telah Berdomisili / tinggal menetap secara berturut - turut sejak <?php echo $dt[2]; ?> sampai dengan sekarang.</td>
  </tr>
  <tr>
