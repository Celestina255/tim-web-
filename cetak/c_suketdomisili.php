...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>Tempat / Tanggal Lahir</td><td>:</td><td><?php echo $r['tmp_lahir'];?>, <?php echo tgl_lahir_indo($tgl_lahir);?> </td>
  </tr>
    <tr>
  ...
  <tr>
    <td colspan="3">Nama tersebut diatas adalah Warga <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> yang telah Berdomisili / tinggal menetap secara berturut - turut sejak <?php echo $dt[2]; ?> sampai dengan sekarang.</td>
  </tr>
  <tr>
    <td colspan="3">Adapun Surat Keterangan ini dibuat untuk melengkapi persyaratan <b><?php echo $dt[3];?></b>.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="3">Demikian Surat Keterangan Domisili ini dibuat dengan sebenarnya untuk dapat dipergunakan sebagaimana mestinya.</td>
  </tr>
