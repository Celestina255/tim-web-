...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <tr>
    <td>Nama Usaha</td><td>:</td><td><b><?php echo $dt[0];?></b></td>
  </tr>
    <tr>
    <td>Bidang Usaha</td><td>:</td><td><?php echo $dt[1];?></td>
  </tr>
    <tr>
    <td>Tahun Berdiri</td><td>:</td><td><?php echo $dt[2];?></td>
  </tr>
    <tr>
    <td>Nama Pemilik Usaha</td><td>:</td><td><?php echo $dt[3];?></td>
  </tr>
    <tr>
    <td>Jumlah Pekerja</td><td>:</td><td><?php echo $dt[4];?> Orang</td>
  </tr>
    <tr>
    <td>Izin Usaha</td><td>:</td><td><?php echo $dt[5];?></td>
  </tr>
    <tr>
    <td>Alamat Tempat Usaha</td><td>:</td><td><?php echo $dt[6];?></td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="3">Tempat Usaha tersebut berlokasi di <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> dan merupakan milik :</td>
  </tr>
  <tr>
