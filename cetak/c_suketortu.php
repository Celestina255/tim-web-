...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo $dt[6]?>  <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?>
 <?php echo $rd['kelurahan'];?></td>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo $dt[13];?>  <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?>
 <?php echo $rd['kelurahan'];?></td>
  </tr>
  </table>
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[20];?> <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?>
 <?php echo $rd['kelurahan'];?></td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
