...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $r['alamat'];?> Kampung <?php echo $r['kelurahan'];?></td>
  </tr>
  <tr>
    ...
    <tr>
    <td colspan="3">Nama tersebut adalah benar Warga <?php echo $rd['jnp'];?> <?php echo $rd['kelurahan'];?> yang memiliki Usaha sebagai berikut :</td>
  </tr>
    <tr>
    <td>Jenis/Bidang Usaha</td><td>:</td><td><?php echo $dt[0];?></td>
  </tr>
      <tr>
    <td>Berjalan Sejak</td><td>:</td><td><?php echo $dt[1];?></td>
  </tr>
      <tr>
    <td>Alamat / Lokasi Usaha</td><td>:</td><td><?php echo $dt[2];?></td>
  </tr>
