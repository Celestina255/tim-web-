...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo $dt[5];?> <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $rd['kelurahan'];?></td>
  </tr>
<tr>
    <td colspan="4">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo $dt[11];?> <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $rd['kelurahan'];?></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
    ...
    <tr>
    <td colspan="4">Warga tersebut diatas adalah bernar Warga <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $rd['kelurahan'];?> yang termasuk kategori Rumah Tangga Miskin.</td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
...
<table width="100%" align="center" border="0" cellspacing="1" cellpadding="4" class="table-print">
    ...
    <tr>
    </td><td width="40%"></td><td align="center" class="pull pull-right" width="40%"><?php echo $rd['kelurahan'];?>,&nbsp;<?php echo $bulan;?></td>
  </tr>
  <tr>
   <td align="center">TKSK Kecamatan <?php echo $rd['kec'];?></td><td align="center" valign="top" class="pull pull-right"><?php echo $rd['jnp']=='Desa'? "Kepala Desa" : "Lurah";?> <?php echo $rd['kelurahan'];?></td>
  </tr>

  <tr>
    <td align="center"><br><br><br>_______________________</td><td align="center" class="pull pull-right"><br><br><br><br><u><b><?php echo $r['ttd'];?></b></u><br>NIP. <?php echo $rd['niplurah'];?></td>
  </tr> 
  <tr>
    <td align="center" colspan="2">Camat <?php echo $rd['kec'];?></td>
  </tr> 
  <tr>
