...
<html>
      ...
      <h1 align="center">
        <table width="97%" align="center" border="0" cellspacing="1" cellpadding="1" class="table-print">
          <tr>
            ...
            <tr>
          <td colspan="3" align="center"><strong><font size=3 color="black">FORMULIR SURAT KETERANGAN KEMATIAN SUAMI/ISTRI
          </font>
    ...
    <table width="90%" align="right" border="0" cellspacing="1" cellpadding="0" class="table-print">
      ...
      <tr>
        ...
        <td></td><td></td><td align="center" class="pull pull-right"><?php echo $r['jab_staff']=='Kepala Kelurahan' || $r['jab_staff']=='Kepala Desa'? "" : "a.n.";?> <?php echo $rd['jnp']=='Desa'? "Kepala Kampung" : "Kepala Kelurahan";?> <?php echo $rd['kelurahan'];?> <br><?php echo $r['jab_staff']=='Kepala Kelurahan' || $r['jab_staff']=='Kepala Desa'? "" : "$r[jab_staff]";?>,</td>
      </tr>
      <tr>
      ...
      <tr>
        <td></td><td align="center" class="pull pull-right"><?php 
        $queryrs = mysqli_query ($con, "SELECT * from setting_surat LIMIT 1");
        while ($rs = mysqli_fetch_array($queryrs)){
          ?>
          <?php if ($rs['ttd'] == 'Otomatis'): ?> <img src="../file/ttd/<?php echo $r['ttd_staff']; ?>" style="width: 7em; height: 7em; margin-right: 10em; margin-top: -1em;"><img src="../file/<?php echo $rd['stample']; ?>" style="width: 7em; height: 7em; margin-left: -14em; margin-top: -1em;"><?php else :?><span>&nbsp;<br><br><br></span><?php endif; ?><br><u><b><?php echo strtoupper($r['nama_staff']);?></b></u>
          <?php } ?></td>
        </tr>
