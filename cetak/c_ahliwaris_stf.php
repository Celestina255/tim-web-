                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="card">
                                    <div class="card-body" style="text-align-last: center;">
                                        ...
                                        <a href="../staff/index.php?page=permohonanaw&amp;kode=<?php echo $row['kode'];?>" type="button" class="btn btn-success" target="_BLANK"><i class="fa fa-edit"></i> Buat Permohonan </a>
                                        
                                        <a href="../staff/index.php?page=suketaw" type="button" class="btn btn-danger"><i class="fa fa-close"></i> Kembali</a>
