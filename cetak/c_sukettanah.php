...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td>3.</td><td>Jenis Kelamin</td><td>:</td><td><?php echo $r['jk'];?></td>
      ...
      <tr>
    <td>4.</td><td>Tempat / Tanggal Lahir</td><td>:</td><td><?php echo $r['tmp_lahir'];?>,  <?php echo tgl_lahir_indo($tgl_lahir);?></td>
  </tr>
      <tr>
    ...
    <tr>
    <td>8.</td><td>Alamat</td><td>:</td><td><?php echo $r['alamat'];?> <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $r['kelurahan'];?></td>
  </tr>
  <tr>
