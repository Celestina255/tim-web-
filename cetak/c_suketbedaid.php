...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="3" align="justify">Yang bertanda tangan dibawah ini <?php echo $rd['jnp']=='Desa'? "Kepala Desa" : "Lurah";?> <?php echo $rd['kelurahan'];?> Kecamatan <?php echo $rd['kec'];?> Kabupaten <?php echo $rd['kab'];?>, menerangkan bahwa Identitas Warga Kelurahan <?php echo $rd['kelurahan'];?>  dibawah ini terdapat perbedaan antara <?php echo $dt[7];?>  dengan <?php echo $dt[15];?>  sebagai berikut :</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[6];?> <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $r['kelurahan'];?></td>
  </tr>
  <tr>
...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[14];?> <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $r['kelurahan'];?></td>
  </tr>
  <tr>
    <td></td><td></td><td>Kec. <?php echo $r['kec'];?> Kab. <?php echo $r['kab'];?></td>
  </tr>
  <tr>
    ...
    <tr>
    <td colspan="3">Warga dengan Identitas tersebut diatas adalah benar <b>Orang yang sama</b> yang merupakan Warga <?php echo $rd['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $rd['kelurahan'];?>.</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
