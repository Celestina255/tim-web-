...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>Tempat / Tanggal Lahir</td><td>:</td><td><?php echo $dt[3];?>, &nbsp;<?php echo tgl_lahir_indo($dt[4]);?></td>
  </tr>
    <tr>
...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td>Tempat / Tanggal Lahir</td><td>:</td><td><?php echo $dt[11];?>, &nbsp; <?php echo tgl_lahir_indo($dt[12]);?></td>
  </tr>
    <tr>
    <td>Agama</td><td>:</td><td><?php echo $dt[13];?></td>
  </tr>
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[14];?> <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?> <?php echo $r['kelurahan'];?></td>
  </tr>
  <tr>
    <td></td><td></td><td> Distrik <?php echo $r['kec'];?> Kabupaten <?php echo $r['kab'];?></td>
  </tr>
  <tr>
    ...
    <tr>
    <td colspan="3">Warga dengan Identitas tersebut diatas adalah benar <b>Orang yang sama</b> yang merupakan Warga <?php echo $rd['jnp']=='Desa'? "kampung" : "Kelurahan";?> <?php echo $rd['kelurahan'];?>.</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
