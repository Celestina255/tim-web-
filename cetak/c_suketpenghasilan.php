...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
 ...
 <?php echo $rd['kelurahan'];?> Distrik <?php echo $rd['kec'];?> Kabupaten <?php echo $rd['kab'];?>, dengan ini menerangkan sesungguhnya bahwa : </td>
  ...
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $r['alamat'];?> <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?>
 <?php echo $r['kelurahan'];?></td>
  ...
  <tr>
    ...
    <td colspan="3">&nbsp;</td>
      ...
      <tr>
    <td colspan="3">Warga tersebut diatas adalah benar Warga <?php echo $rd['jnp']=='Desa'? "Kampung" : "Kelurahan";?>
