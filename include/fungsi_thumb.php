...
function UploadBerita($fupload_name) {
    ...
    // Pindahkan file asli ke folder berita
    move_uploaded_file($_FILES["file"]["tmp_name"], $vfile_upload);

    // Buat thumbnail 'palsu' (hanya copy file asli tanpa resize)
    $thumb_file = $vdir_upload . "kecil_" . $fupload_name;
    copy($vfile_upload, $thumb_file);
}
