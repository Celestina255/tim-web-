<?php
include '../koneksi.php';
$sambutan = mysqli_query($con, "SELECT * FROM tb_sambutan LIMIT 1");
$data = mysqli_fetch_assoc($sambutan);
?>
...
<!-- Service Section end-->
  ...
  <div class="container">
    <div class="row text-center mb-4">
      <div class="col-md-12">
        <h2 class="section-title" style="color: #2caa50; font-weight: 700;">GALERI KAMPUNG</h2>
      </div>
    </div>

    <div class="row justify-content-center">
      <?php 
      $query = mysqli_query($con, "SELECT * FROM tb_galeri ORDER BY id ASC LIMIT 6");
      while ($r = mysqli_fetch_array($query)) {
      ?>
    ...
    <div class="row">
      <div class="col-md-12 text-center mt-3">
        <a href="?page=galeri" class="btn btn-success px-4 py-2">Lihat Foto Lebih Banyak</a>
      </div>
    </div>
  </div>
</section>
