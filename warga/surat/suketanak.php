...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-9">
            <h3 class="title-5">SURAT KETERANGAN ANAK
            </h3>
        </div>
        <div class="col-md-3">
            ...
            <div class="row form-group">
                ...
                <div class="col-12 col-md-8">
                    <select name="nmsurat" id="nmsurat" onchange="isiredaksi()" class="form-control">
                        ...
                        <?php 
                        $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS010' ORDER BY id ASC ");
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Surat Keterangan Anak</strong>
                        </div>
                        ...
                        <div class="card-body scroll">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat, tb_buatsendiri WHERE tb_detailsurat.kode=tb_buatsendiri.kode_surat AND tb_detailsurat.kodejenis='JS010' AND tb_buatsendiri.status='acc' AND tb_buatsendiri.userid='$userid' ORDER BY tb_detailsurat.id DESC ");
                                $no=1;
                                    while ($r = mysqli_fetch_array($query)){
                                        $dt=explode(';', $r['detail'])
                                        ?>
