...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-9">
            <h3 class="title-5">SURAT KETERANGAN DOMISILI LEMBAGA
            </h3>
        </div>
        <div class="col-md-3">
    ...
    <div class="card-body card-block" style="box-shadow: 4px 5px 4px;">
                            <?php
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS031' ORDER BY id ASC ");
                                ...
                                <hr>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt"  placeholder="Alamat Lengkap Lembaga" required class="form-control"><small class="form-text text-muted">Contoh : Kp. Durian Runtuh Rt. 001/Rw. 002 Kelurahan Pamulihan Kec. Way Sulan Kab. Lampung Selatan Prov. Lampung</small></div>
                                    </div>
                                    <div class="row form-group">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Surat Keterangan Domisili Lembaga</strong>
                            </div>
                        ...
                        <?php 
                            $userid=$_SESSION['userid'];
                                $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat, tb_buatsendiri WHERE tb_detailsurat.kode=tb_buatsendiri.kode_surat AND tb_detailsurat.kodejenis='JS031' AND tb_buatsendiri.status='acc' AND tb_buatsendiri.userid='$userid' ORDER BY tb_detailsurat.id DESC ");
                            $no=1;
