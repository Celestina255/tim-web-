...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-9">
            <h3 class="title-5">SURAT PENGANTAR PERMOHONAN KTP
            </h3>
        </div>
        <div class="col-md-3">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-8">
                        <select name="nmsurat" id="nmsurat" onchange="isiredaksi()" class="form-control">
                            ...
                            <?php 
                            $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS032' ORDER BY id ASC ");
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9"><input type="text" id="almt" name="almt" placeholder="Kp. Durian Runtuh, RT./RW. 001/002
                            " class="form-control"><small class="form-text text-muted">Contoh : Kp. Durian Runtuh, RT./RW. 001/002</small></div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                $query = mysqli_query ($con, "SELECT * FROM tb_buatsendiri, tb_detailsurat JOIN tb_penduduk ON tb_penduduk.nik=tb_detailsurat.nik WHERE tb_detailsurat.kode=tb_buatsendiri.kode_surat AND tb_detailsurat.kodejenis='JS032' AND tb_buatsendiri.status='acc' AND tb_buatsendiri.userid='$userid' ORDER BY tb_detailsurat.id DESC ");
                                            $no=1;
