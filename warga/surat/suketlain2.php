...
<div class="container mt-4">
    <div class="row">
        <div class="col-md-9">
            <h3 class="title-5">SURAT KETERANGAN LAIN - LAIN (UMUM)
            </h3>
        </div>
        <div class="col-md-3">
    ...
    <div class="card-body card-block" style="box-shadow: 4px 5px 4px;">
                            <?php
                                ...
                                <div class="row form-group">
                                    ...
                                    <?php 
                                    $query = mysqli_query ($con, "SELECT * FROM tb_jenissurat WHERE kode='JS099' ORDER BY id ASC ");
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Surat Keterangan Lain - lain </strong>
                            </div>
                        ...
                        <?php 
                            $userid=$_SESSION['userid'];
                                $query = mysqli_query ($con, "SELECT * FROM tb_detailsurat, tb_buatsendiri WHERE tb_detailsurat.kode=tb_buatsendiri.kode_surat AND tb_detailsurat.kodejenis='JS099' AND tb_buatsendiri.status='acc' AND tb_buatsendiri.userid='$userid' ORDER BY tb_detailsurat.id DESC ");
                            $no=1;
